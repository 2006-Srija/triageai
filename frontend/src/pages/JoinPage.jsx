    ...
    <div className="min-h-screen flex bg-gray-950">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <h2 className="text-2xl font-bold text-white mb-1">Join your team</h2>
          <p className="text-gray-400 mb-8">Enter your team's invite code</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input name="inviteCode" value={form.inviteCode} onChange={handleChange} className="input-field" placeholder="e.g. a1b2c3d4e5f6" required />
            </div>
            <div>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/signup" className="text-accent-blue hover:text-blue-400 font-medium">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
